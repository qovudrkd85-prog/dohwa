# -*- coding: utf-8 -*-
"""ASOS 월자료 CSV → excel_export.py 입력 JSON 변환."""
import csv, json, sys, io

SRC = r"E:\개인 FIle\00_dohwa\03_토목기술팀\01_data-download-desk\업무\2026-05-18_문경_ASOS월자료_2016-2025\문경_ASOS_월자료_201601-202512.csv"
OUT = r"E:\개인 FIle\00_dohwa\03_토목기술팀\02_weather-desk\업무\2026-05-18_문경_2016-2025\rows.json"
...
def find(header, *needles, exclude=()):
    """헤더에서 needle 전부 포함 + exclude 미포함 컬럼 index 반환."""
