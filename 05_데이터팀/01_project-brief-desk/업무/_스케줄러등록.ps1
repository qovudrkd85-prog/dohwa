...
# 사용법(1회): powershell -NoProfile -File _스케줄러등록.ps1
# 해제하려면: Unregister-ScheduledTask -TaskName '도화_데이터팀_09시점검' -Confirm:$false
# =====================================================================
...
Write-Output ''
Write-Output '완료. 확인: schtasks /query /tn 도화_데이터팀_09시점검'
